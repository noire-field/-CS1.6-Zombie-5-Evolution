...
#define PLUGIN "[Mileage] Equipment: Holy Bomb"
#define VERSION "1.0"
#define AUTHOR "Dias"

#define HOLYBOMB_DAMAGE 500
...
{
	"models/mileage_wpn/equip/v_holybomb.mdl",
	"models/mileage_wpn/equip/p_holybomb.mdl",
	"models/mileage_wpn/equip/w_holybomb.mdl"
}
...
public plugin_init()
{
	...
	g_HolyBomb = Mileage_RegisterWeapon("holybomb")
}
...
{
	if(ItemID == g_HolyBomb) g_had_holybomb[id] = 0
}
