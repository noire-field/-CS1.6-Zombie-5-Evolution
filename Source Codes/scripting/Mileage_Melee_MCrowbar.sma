...
#define DAMAGE_MULTI 8.0 // 12.0 for zombie

#define MODEL_V "models/mileage_wpn/melee/v_crowbarcraft.mdl"
#define MODEL_P "models/mileage_wpn/melee/p_crowbarcraft.mdl"
...
public plugin_init()
{
	...
	g_Crowbar = Mileage_RegisterWeapon("mcrowbar")
}
...
{
	if(ItemID == g_Crowbar) Get_Crowbar(id)
}

public Mileage_WeaponRemove(id, ItemID)
{
	if(ItemID == g_Crowbar) Remove_Crowbar(id)
}
