...
#define PLUGIN "[Mileage] Melee: Janus-9"
#define VERSION "1.0"
...
------------ Configs -------------
=================================*/
#define DAMAGE_A 350 // 200 for Zombie
#define DAMAGE_B 700 // 400 for Zombie

#define RADIUS_A 86
#define RADIUS_B 100

#define DELAY_TIME 0.65
#define RESET_TIME 5.0

#define ANIMEXT_A "knife"
#define ANIMEXT_B "knife"

#define V_MODEL "models/mileage_wpn/melee/v_janus9.mdl"
#define P_MODEL_A "models/mileage_wpn/melee/p_janus9a.mdl"
#define P_MODEL_B "models/mileage_wpn/melee/p_janus9b.mdl"
...
public plugin_init()
{
	...
	g_Janus9 = Mileage_RegisterWeapon("janus9")
}
...
{
	if(ItemID == g_Janus9) Remove_Janus9(id)
}
...
public Janus9_Damage(id, Special)
{
	...
	for(new i = 0; i < get_maxplayers(); i++)
	{
		...
		|| get_distance_f(VicOrigin, Point[3]) <= Point_Dis)
		{
			...
			if(!Special) ExecuteHamB(Ham_TakeDamage, i, ent, id, float(DAMAGE_A), DMG_SLASH)
			else ExecuteHamB(Ham_TakeDamage, i, ent, id, float(DAMAGE_B), DMG_SLASH)
		}
	}	
