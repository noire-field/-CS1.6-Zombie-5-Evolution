...
#define PLUGIN "[Mileage] Primary: Volcano"
#define VERSION "1.0"
#define AUTHOR "Dias"
...
{
	"models/mileage_wpn/pri/v_gatling.mdl", // V
	"models/mileage_wpn/pri/p_primary.mdl", // P
	"models/mileage_wpn/pri/w_primary.mdl" // W
}

new const WeaponSound[1][] =
{
...
public plugin_init() 
{
	...
	register_clcmd("volcano", "get_gatling")
	g_Volcano = Mileage_RegisterWeapon("gatling")
}
