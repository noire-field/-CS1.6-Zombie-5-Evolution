...
#define SUBMODEL 11
#define V_MODEL "models/mileage_wpn/pri/v_sfsniperF.mdl"
...
public plugin_init() 
{
	...
	g_Thunderbolt = Mileage_RegisterWeapon("thunderbolt")
}
...
{
	if(ItemID == g_Thunderbolt) cs_set_user_bpammo(id, CSW_THUNDERBOLT, DEFAULT_AMMO)
}
