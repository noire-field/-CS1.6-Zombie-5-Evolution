...
#define PLUGIN "[Mileage] Melee: Papin"
#define VERSION "1.0"
#define AUTHOR "Dias Pendragon"

#define DAMAGE_A 240 // 240 for Zombie
#define DAMAGE_B 480 // 480 for Zombie
...
#define MODEL_V "models/mileage_wpn/melee/v_spknife.mdl"
#define MODEL_P "models/mileage_wpn/melee/p_spknife.mdl"
...
public plugin_init()
{
	...
	g_Papin = Mileage_RegisterWeapon("papin")
}
...
{
	if(ItemID == g_Papin) Get_Papin(id)
}

public Mileage_WeaponRemove(id, ItemID)
{
	if(ItemID == g_Papin) Remove_Papin(id)
}
...
public Reset_Now(id)
{
	if(is_alive(id)) Update_SpecialAmmo(id, g_SteamPower[id], 0)
}
