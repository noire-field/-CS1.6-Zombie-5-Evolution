...
#define SUBMODEL 6
#define V_MODEL "models/mileage_wpn/pri/v_janusmk5.mdl"
...
public plugin_init()
{
	...
	g_Janus5 = Mileage_RegisterWeapon("janus5")
}
...
{
	if(ItemID == g_Janus5) Give_RealAmmo(id, CSW_JANUS5)
}
