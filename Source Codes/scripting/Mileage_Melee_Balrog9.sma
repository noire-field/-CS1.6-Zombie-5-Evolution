...
#define PLUGIN "[Mileage] Melee: Balrog-9"
#define VERSION "1.0"
...
#define DAMAGE_A 200 // 250 for Zombie
#define DAMAGE_B 300 // 350 for Zombie
...
#define V_MODEL "models/mileage_wpn/melee/v_balrog9n.mdl"
#define P_MODEL "models/mileage_wpn/melee/p_balrog9n.mdl"
...
public plugin_init()
{
	...
	g_Balrog9 = Mileage_RegisterWeapon("balrog9")
...
{
	if(ItemID == g_Balrog9) Get_Balrog9(id)
}
