...
#define PLUGIN "[Mileage] Melee: LightSaber"
#define VERSION "1.0"
...
------------ Configs -------------
=================================*/
#define DAMAGE_LIGHTSABER 124
#define DAMAGE_ATTACK 62
...
#define ANIMEXT1 "knife"
#define ANIMEXT2 "knife"

#define V_MODEL "models/mileage_wpn/melee/v_sfsword.mdl"
#define P_MODEL_ON "models/mileage_wpn/melee/p_sfsword_on.mdl"
#define P_MODEL_OFF "models/mileage_wpn/melee/p_sfsword_off.mdl"
...
public plugin_init() 
{
	...
	g_Lightsaber = Mileage_RegisterWeapon("beamsword")
}
