...
#define MODEL_V "models/mileage_wpn/pri/v_blockar1.mdl"
#define MODEL_V2 "models/mileage_wpn/pri/v_blockar2.mdl"
#define MODEL_VC "models/mileage_wpn/pri/v_blockchange.mdl"
#define MODEL_P "models/mileage_wpn/pri/p_blockar1.mdl"
#define MODEL_P2 "models/mileage_wpn/pri/p_blockar2.mdl"
#define MODEL_W "models/mileage_wpn/pri/w_blockar1.mdl"
#define MODEL_W2 "models/mileage_wpn/pri/w_blockar2.mdl"
#define MODEL_S "models/mileage_wpn/pri/block_missile.mdl"
#define MODEL_SHELL "models/mileage_wpn/pri/block_shell.mdl"
...
public plugin_init()
{
	...
	g_BlockAR = Mileage_RegisterWeapon("blockar")
}
...
{
	if(ItemID == g_BlockAR) cs_set_user_bpammo(id, CSW_BLOCKAR, BPAMMO)
}

public Mileage_WeaponRemove(id, ItemID)
{
	if(ItemID == g_BlockAR) Remove_BlockAR(id)
}
