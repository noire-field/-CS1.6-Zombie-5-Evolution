...
#define PLUGIN "[Mileage] Secondary: Skull-I"
#define VERSION "1.0"
#define AUTHOR "Dias Pendragon"

#define MILEAGE_CODENAME "skull1"

// Data Config
#define MODEL_V "models/mileage_wpn/sec/v_skull1.mdl"
...
#define SOUND_FIRE "weapons/skull1-1.wav"

#define CSW_BASE CSW_DEAGLE
#define weapon_base "weapon_deagle"

#define SUBMODEL 0 // can -1
#define WEAPON_CODE 1182015
#define WEAPON_EVENT "events/deagle.sc"

#define ANIME_SHOOT 2
#define ANIME_RELOAD 6 // can -1
#define ANIME_DRAW 7 // can -1
...
public plugin_init()
{
	...
	// Get
	g_Base = Mileage_RegisterWeapon(MILEAGE_CODENAME)
}
...
public fw_PlaybackEvent(flags, invoker, eventid, Float:delay, Float:origin[3], Float:angles[3], Float:fparam1, Float:fparam2, iParam1, iParam2, bParam1, bParam2)
{
	...
	Set_WeaponAnim(invoker, Get_BitVar(g_RapidShot, invoker) ? 4 : ANIME_SHOOT)
...
public fw_Weapon_PrimaryAttack_Post(Ent)
{
	...
	if(Get_BitVar(g_RapidShot, id)) set_pdata_int(Ent, 64, 0, 4)
}
