...
#define SUBMODEL 7
#define V_MODEL "models/mileage_wpn/pri/v_thanatos5.mdl"
#define P_MODEL "models/mileage_wpn/pri/p_primary.mdl"
#define W_MODEL "models/mileage_wpn/pri/w_primary.mdl"
#define S_MODEL "models/mileage_wpn/pri/thanatos5_bulleta.mdl"
...
public plugin_init() 
{
	...
	g_Thanatos5 = Mileage_RegisterWeapon("thanatos5")
}
...
{
	if(ItemID == g_Thanatos5) cs_set_user_bpammo(id, CSW_THANATOS5, 200)
}

public Mileage_WeaponRemove(id, ItemID)
{
	if(ItemID == g_Thanatos5) Remove_Thanatos5(id)
}
